...
| Inactive  | not engaging or involving in any social action | Robot enters in the room quietly |
...
Some images produced with Sketchup 3D can demonstrate the general idea:

![Person looking to the camera in quiet room](img/sample_active.jpg?raw=true)